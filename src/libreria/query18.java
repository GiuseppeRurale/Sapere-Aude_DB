...
public class query18 extends JFrame {
	...
	public query18() {
		...
		setTitle("OPERE AUTORI ITALIANI");
		...
		JLabel indexLabel = new JLabel("Opere di autori italiani:");
		...
		try {
			String l = "SELECT opera.nome, mediaVoti, autore.nome, categoria FROM opera INNER JOIN autore ON autore = idAutore WHERE nazionalita = \"IT\";";
