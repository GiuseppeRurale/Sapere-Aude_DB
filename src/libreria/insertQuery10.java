...
public class insertQuery10 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public insertQuery10() {
		setTitle("ACQUISTO OPERA DIGITALE");
		...
		JLabel operaLabel = new JLabel("Inserisci l'ID dell'opera digitale da acquistare:");
		...
		catalogoButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							printDigitalBooks frame = new printDigitalBooks();
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query10 = "INSERT INTO acquistopera(dataAcquisto, tipoOpera, opera, ordine) VALUES(NOW(), 0, ?, ?)";
					PreparedStatement ps10 = Login.con.prepareStatement(query10);
					ps10.setString(1, operaField.getText());
					ps10.setString(2, ordineField.getText());
					String query102 = "UPDATE ordine SET importoTotale = importoTotale + (SELECT costoAcquisto FROM operadigitale WHERE opera = ?) WHERE idOrdine = ?;";
					PreparedStatement ps102 = Login.con.prepareStatement(query102);
					ps102.setString(1, operaField.getText());
					ps102.setString(2, ordineField.getText());
					int r = ps10.executeUpdate();
					int r2 = ps102.executeUpdate();
					if(r!=0 && r2!=0) {
