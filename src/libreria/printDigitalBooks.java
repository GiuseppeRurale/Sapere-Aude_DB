...
public class printDigitalBooks extends JFrame {
	...
	public printDigitalBooks() {
		...
		try {
			String b = "SELECT idOpera, opera.nome, mediaVoti, autore.nome, numeroPagine, linguaTesto, costoAcquisto FROM opera INNER JOIN operadigitale INNER JOIN autore ON idOpera = opera && autore=idAutore;";
