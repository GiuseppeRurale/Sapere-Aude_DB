...
public class query17 extends JFrame {
	...
	public query17() {
		...
		JLabel indexLabel = new JLabel("Opere classificate in base alle valutazioni:");
		...
		try {
			String l = "SELECT opera.nome, mediaVoti, autore.nome, categoria FROM opera INNER JOIN autore ON autore = idAutore ORDER BY mediaVoti desc, opera.nome asc;";
