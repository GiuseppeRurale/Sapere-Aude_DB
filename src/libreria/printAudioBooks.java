...
public class printAudioBooks extends JFrame {
	...
	public printAudioBooks() {
		...
		try {
			String b = "SELECT idOpera, opera.nome, mediaVoti, autore.nome, durata, linguaAudio, costoAcquisto FROM opera INNER JOIN audiolibro INNER JOIN autore ON idOpera = opera && autore=idAutore;";
